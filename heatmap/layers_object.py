...
def conv_layer(bottom, name, shape, is_training=True, use_vgg=False, vgg_param_dict=None):
    """
    Inputs:
    ...
    def get_conv_filter(val_name):
        return vgg_param_dict[val_name][2]
...
def up_sampling(pool, ind, output_shape, batch_size, name=None):
    ...
    with tf.variable_scope(name):
        ...
        #a=tf.range(batch_size, dtype=ind.dtype)
