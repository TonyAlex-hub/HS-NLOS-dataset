...
import cv2 as cv
flags = tf.app.flags
flags.DEFINE_string("input", "/data1/cmy/heatmap/laska.png", "Path to input image ['laska.png']")
flags.DEFINE_string("output", "/data1/cmy/heatmap/laska_grad.jpg", "Path to input image ['laska_save.png']")
...
def main(_):
	...
	vgg = vgg16(imgs, '/data1/cmy/vgg_save/vgg16_weights.npz', sess)
